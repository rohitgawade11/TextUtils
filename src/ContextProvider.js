...
export default function ContextProvider() {
    ...
    const {handleUpClick,handleLoClick,handleExtraSpaces,findAndReplace} = context;
  return (
   <>
  ...
  <Router>
    ...
    <Routes>
        ...
        <Route path='/find-and-replace' element={<TextForm alert={alert} clickEvent={findAndReplace} example={{ex:"this is my bad line",op:"this is my first line"}} />} />
    </Routes>
    <Footer />
    </Router>
