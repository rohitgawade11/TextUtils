  ...
  let myStyle = {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#042743'}}> 
            ...
            <button disabled={text.length===0} style={myStyle} className="btn btn-secondary mx-1 my-1" onClick={handleLoClick}>Convert to Lowercase</button>
            <button disabled={text.length===0} style={myStyle} className="btn btn-secondary mx-1 my-1" onClick={handleClearClick}>Clear Text</button>
            <button disabled={text.length===0} style={myStyle} className="btn btn-secondary mx-1 my-1" onClick={handleCopy}>Copy Text</button>
